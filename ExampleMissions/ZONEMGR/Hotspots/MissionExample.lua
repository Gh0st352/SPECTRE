...
--    :enableHotspotIntel()                           -- Enables deeper world state analysis in managed zones. It will place a text marker in the center of hotspots with a brielf intel summary of units contained within.
--    :enableSSB()
...
-------------------------------------------------------------------------------------------------------------------------------------------------
--
-- Dynamically Genberating Units for the example. You may ignore the below information, or see `AdvancedSpawner` example.
--
-------------------------------------------------------------------------------------------------------------------------------------------------
