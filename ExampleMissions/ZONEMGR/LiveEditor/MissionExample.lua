...
--- Add Live Edit Spawners
-- 
-- When using the LiveEdit features, it will randomly pull a spawner for the respective functions.
zoneManager:AddAirfieldSpawnerTemplate(BLUEspawner, "spawnerAirfield")
zoneManager:AddFillSpawnerTemplate(BLUEspawner, "spawnerFill", true)
